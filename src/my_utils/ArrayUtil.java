...
public class ArrayUtil {
    /*
    Group of utility methods for the Arrays
    Extra practices from 8/01 will be done here.
     */
 ...
 */
    ...
    create a method that will accept an int array and return the biggest number from the array
        */
    public static int max(int... arr) {// int[] arr IS THE SAME AS int ...arr
        int max = arr[0];
...
create a method that will accept an int array and an int number. Find and return the index of the number in the array. If there is multiple occurrence return the first occurrence's index
     ...
     */
// if you want to use the var args: public static int indexOf(int num, int ... arr){

    public static int indexOf(int[] arr, int num) {
        for (int i = num; i < arr.length; i++) {
            if (arr[i] == num) {// every number from the array with the number we are.
                return i;
            }
        }
        return -1;
    ...
    public static int indexOf(int[] arr, int target, int startIndex) {
        for (int i = startIndex; i < arr.length; i++) {
            if (arr[i] == target) {// every number from the array with the number we are.
                return i;
            }
        }
        return -1;
    ...
    public static String[] addElement(String[] arr, String element) {
        ...
        for (int i = 0; i < arr.length; i++) {// add all the elements from the original array to newArr[i]= arr[i];
            newArr[i] = arr[i];
        }
        newArr[newArr.length - 1] = element; // add the element to the end of the new array
    ...
    public static String[] addElements(String[] original, String [] other){
        ...
        for (int i = 0; i < original.length; i++) {//copy the elements from the original array to array the new array.
            merged[i] = original[i];
        }
