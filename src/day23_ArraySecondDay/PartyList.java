...
public class PartyList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(names));// showing the empty array created, based om the size from the console

        for (int i = 0; i < names.length; i++) {// purpose: ask for the name and store to the array
            System.out.println("Enter the name of person " + (i+1));// if you dont have parenthsis the line will concatenate left to right but we have to do addition first i + 1 , then concatenate the message
