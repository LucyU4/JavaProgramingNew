...
boolean b = word.startsWith("hello"); //method returns boolean so you can declarea boolean variable

        String s = "hello world today";
        System.out.println("word.startsWith(hello world) " + s.startsWith("hello world"));
